  ...
  return (
    <>
      ...
      <p className="mb-3 text-justify text-sm leading-snug text-[#1d120b] lg:text-base">
        Ethe Trade is a Dubai-based trading and brand development company,
        focused on delivering premium products and building distinctive brands
        that stand out in competitive markets.
      </p>

      <p className="mb-3 text-justify text-sm leading-snug text-[#1d120b] lg:text-base">
        We combine strategic sourcing with creative thinking to transform
        products into meaningful brand experiences.
      </p>
      ...
      <div className="border-2 border-[#2a1a0f] bg-[#d4c4a8]/55 p-3 shadow-[inset_0_0_18px_rgba(139,115,85,0.28)]">
        ...
        <p className="text-justify text-sm leading-snug text-[#1d120b] lg:text-base">
          We don't follow the market, we elevate it. Our strength lies in
          merging trade expertise with creative direction, allowing us to build
          brands that are both commercially successful and visually distinctive.
        </p>
      </div>
    </>
  );
